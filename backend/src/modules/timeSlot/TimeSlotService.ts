...
export class TimeSlotService {
    ...
    createTimeSlot = async (newTS:NewTSREquest, transaction:Transaction): Promise<any> => {
        const createdTimeSlot = await this.timeSlotRepository.createTimeSlot(newTS, transaction);
